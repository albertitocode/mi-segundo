...
public class RopaClinica extends Ropa {
    ...
    int rpc_cliente;
    int rpc_precio;
    int rpc_tiempoDeEntrega;
    public RopaClinica() {
    }

    public RopaClinica(int rpc_id, String rpc_estado, String rpc_dano,String rpc_usuario,int rpc_cliente,int rpc_precio,int rpc_tiempoDeEntrega, int rp_id, String rp_nombre, String rp_marca, String rp_descripcion, String rp_color, String rp_categoria) {
        ...
        this.rpc_cliente=rpc_precio;
        this.rpc_tiempoDeEntrega=rpc_tiempoDeEntrega;
    }

    public int getRpc_tiempoDeEntrega() {
        return rpc_tiempoDeEntrega;
    }

    public void setRpc_tiempoDeEntrega(int rpc_tiempoDeEntrega) {
        this.rpc_tiempoDeEntrega = rpc_tiempoDeEntrega;
    }
    
    public int getRpc_precio() {
        return rpc_precio;
    }

    public void setRpc_precio(int rpc_precio) {
        this.rpc_precio = rpc_precio;
    }
