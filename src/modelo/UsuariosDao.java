...
//        }
    ...
    public int setActualizarr(Usuarios us,int idrol){
        String sql="UPDATE usuarios SET persona_nombre=?, persona_apellido=?, usuario_email=?, usuario_contrasena=?,usuario_telefono=?, rol_log=? WHERE persona_id="+us.getPersona_id();
